...
const Counter = () => {
   ...
   // Xảy ra 1 số tình huống: Công việc phụ (Side Effect)
   // if (count >= 5 && count <= 10) {
   //    a = count;
   // }
   // useEffect(() => {
...
- dependencies --> Optión để quyết định khi nào chạy hàm callback trong useEffect
...
+ null hoặc undefind --> Hàm callback chỉ chạy khi component re-render
*/
